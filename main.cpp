...
int main()
{
	...
	GLfloat vertices[] =
	{
		...
		0.0f, 0.5f * float(sqrt(3)) * 2 / 3, 0.0f, // Upper corrner
	};
	...
	GLuint VAO, VBO;
	// Generate the VAO and VBO with only object each
	...
	// Bind both the VBO and VAO to 0 so that we don't modify them
